...
export default function Intro() {
  ...
  useEffect(() => {
    const open = () => {
      ...
      timer.current = setTimeout(finish, 3600);
    };
    let seen = false;
