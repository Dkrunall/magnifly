...
export default function Footer() {
  return <footer className="footer studio-footer">
    <div className="footer-invitation">
      <div><span className="eyebrow">YOUR NEXT CHAPTER STARTS HERE</span><h2>Let’s make<br />something <em>matter.</em></h2></div>
    ...
    <div className="footer-landing" aria-hidden="true"><span>Ideas take flight.</span></div>
